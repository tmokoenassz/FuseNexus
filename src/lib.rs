...
#[derive(Debug)]
pub struct FuseNexusProcessor {
    verbose: bool,
    processed_count: usize,
}

impl FuseNexusProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting FuseNexus processing");
    
    let mut processor = FuseNexusProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = FuseNexusProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = FuseNexusProcessor::new(false);
